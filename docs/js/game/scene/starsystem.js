...
import * as perlin from '/proyecto-fin-ciclo/js/libs/perlin.js';
...
function initResources() {
	...
	for (let i = 0; i < STAR_TEXTURES; ++i) {
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/star' + i + '.png');
	...
	for (let i = 0; i < PLANET_TEXTURES; ++i) {
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/dirt' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
			planetDirtTextures.push(texture);
		}
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/water' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
			planetWaterTextures.push(texture);
		}
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/alien' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
	...
	for (let i = 0; i < CLOUD_TEXTURES; ++i) {
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/cloud' + i + '.png');
		texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
		texture.minFilter = texture.magFilter = graphics.filtering;
	...
	for (let i = 0; i < NORMAL_TEXTURES; ++i) {
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/normals/normal-dirt' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
			planetDirtNormals.push(texture);
		}
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/normals/normal-water' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
			planetWaterNormals.push(texture);
		}
		{
			let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/normals/normal-alien' + i + '.png');
			texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
			texture.minFilter = texture.magFilter = graphics.filtering;
	...
	for (let i = 0; i < NORMAL_CLOUD_TEXTURES; ++i) {
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/normals/normal-cloud' + i + '.png');
		texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
		texture.minFilter = texture.magFilter = graphics.filtering;
		planetCloudNormals.push(texture);
	}
	
	planetCraterNormal = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/star-system/normals/normal-crater.png');
