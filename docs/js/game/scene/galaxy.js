...
function initDust() {
	// Texturas.
	{
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/dust0.png');
		texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
		texture.minFilter = texture.magFilter = graphics.filtering;
	...
	{
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/dust1.png');
		texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
		texture.minFilter = texture.magFilter = graphics.filtering;
	...
	{
		let texture = new THREE.TextureLoader().load('/proyecto-fin-ciclo/image/dust2.png');
		texture.wrapS = texture.wrapT = THREE.ClampToEdgeWrapping;
